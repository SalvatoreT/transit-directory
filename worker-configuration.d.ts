/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 335c40407352f715e50c322ce62223c8)
// Runtime types generated with workerd@1.20251217.0 2025-12-20 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		IMPORT_TRIP_UPDATES_WORKFLOW: Workflow<Parameters<import("./dist/_worker.js/index").ImportTripUpdatesWorkflow['run']>[0]['payload']>;
		IMPORT_VEHICLE_POSITIONS_WORKFLOW: Workflow<Parameters<import("./dist/_worker.js/index").ImportVehiclePositionsWorkflow['run']>[0]['payload']>;
		IMPORT_SERVICE_ALERTS_WORKFLOW: Workflow<Parameters<import("./dist/_worker.js/index").ImportServiceAlertsWorkflow['run']>[0]['payload']>;
	}
}
